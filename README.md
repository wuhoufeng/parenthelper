...
[![Build Status](https://travis-ci.org/AndroidBootstrap/com-ksn-parenthelper.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/com-ksn-parenthelper)

This repository contains the source code for the [ParentHelper](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=com.ksn.parenthelper).

Please see the [issues](https://github.com.ksn.parenthelper/com-ksn-parenthelper/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about ParentHelper? Ask away on the [com-ksn-parenthelper discussion forum](https://groups.google.com/forum/#!forum/com-ksn-parenthelper).

<a href="https://play.google.com/store/apps/details?id=com.ksn.parenthelper" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __com.ksn.parenthelper__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____com.ksn.parenthelper__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.com.ksn.parenthelper.R__) will now be renamed
...
signed with a different key.  Manually uninstall ParentHelper from your device and
...
ParentHelper is a result of a template project I've developed over the years as well as
...
ParentHelper is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.com.ksn.parenthelper/com-ksn-parenthelper/contributors) on
...
[pull requests](https://github.com.ksn.parenthelper/com-ksn-parenthelper/pulls).
