...
import com.ksn.parenthelper.events.NavItemSelectedEvent;
import com.ksn.parenthelper.util.Ln;
import com.ksn.parenthelper.util.SafeAsyncTask;
import com.ksn.parenthelper.util.UIUtils;
 ...
 * {@link com.ksn.parenthelper.authenticator.ApiKeyProvider#getAuthKey(android.app.Activity)}
 */
    ...
    private void initScreen(Bundle savedInstanceState) {
        if (userHasAuthenticated) {
            ...
            fragmentManager.beginTransaction()
                    .replace(R.id.container, new T_Main_fragment())
                    .commit();
        }

    }

    private void checkAuth(final Bundle savedInstanceState) {
