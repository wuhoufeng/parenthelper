...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.ksn.parenthelper";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "ParentHelper";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.ksn.parenthelper.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.ksn.parenthelper.";
